# Subtask 1 - Crawl through the directories to obtain file structure,
# file name, file type, and other useful information
...
def get_root_structure(filepath):
    """Get the file structure of the file path and return a dictionary
       --------------------------------------------------------------
       Input: "file path" (str)
       Output: a dictionary with 'subroot':['file1', 'file2', ...]"""
    root_structure = {}
    try:
